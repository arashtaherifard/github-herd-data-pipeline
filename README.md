...
> **Introduction to Data Science final project — University of Tehran**
>
> This repository preserves the original Phase 2 Git history and upgrades the portfolio version to the final Phase 3 implementation.
>
> Large raw/processed datasets, trained model binaries, local MLflow storage, and bulky generated audit artifacts are intentionally excluded. Source code, workflow definitions, reports, figures, data schemas, collector scripts, and reproducibility infrastructure are retained.
